...
export const ServicesDirectory: React.FC = () => {
  ...
  const specializationDetails: Record<string, { icon: string; description: string }> = {
    'Administrative Law': { icon: 'scales', description: 'Government regulations and compliance' },
    'Adoption Law': { icon: 'people', description: 'Adoption and guardianship proceedings' },
    'Antitrust Law': { icon: 'shield', description: 'Competition and monopoly laws' },
    ...
    'DUI/DWI': { icon: 'gavel', description: 'Drunk driving defense' },
    'Education Law': { icon: 'book', description: 'School and education law' },
    'Employment Law': { icon: 'briefcase', description: 'Employment contracts and disputes' },
    ...
    'Insurance Law': { icon: 'shield', description: 'Insurance claims and coverage disputes' },
    ...
    'Mediation': { icon: 'handshake', description: 'Dispute mediation and resolution' },
    ...
    'Probate Law': { icon: 'document', description: 'Estate administration and probate' },
    'Product Liability': { icon: 'warning', description: 'Defective product claims' },
    'Real Estate': { icon: 'house', description: 'Property disputes, contracts, title issues' },
    'Real Estate Development': { icon: 'building', description: 'Real estate development projects' },
    'Regulatory Compliance': { icon: 'clipboardCheck', description: 'Regulatory and compliance matters' },
    'Securities Law': { icon: 'chart', description: 'Securities and investment law' },
    'Social Security': { icon: 'document', description: 'Social Security and benefits' },
    ...
    'Trust Law': { icon: 'sealedDocument', description: 'Trust creation and administration' },
    'White Collar Crime': { icon: 'gavel', description: 'Fraud, embezzlement, and financial crimes' },
